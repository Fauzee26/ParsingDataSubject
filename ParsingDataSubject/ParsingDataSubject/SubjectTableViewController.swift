...
class SubjectTableViewController: UITableViewController {
    let subjectURL = "https://android-examples.000webhostapp.com/all_subjects.php"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.lblNum.text = subject[indexPath.row].id
        cell.lblSubject.text = subject[indexPath.row].name

        return cell
    }
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath){
        //mengecek data yang dikirim
        let dataTask = subject[indexPath.row]
        //memasukan data ke variable namaSelected dan image selected ke masing masing variable nya
        numberSelected = dataTask.id
        subjectSelected = dataTask.name
    ...
    func parseJsonData(data: Data) -> [Subject] {
        ...
        do{
            ...
            for jsonLoan in jsonLoans {
                ...
                SuBjEcT.id = jsonLoan["id"] as! String
                SuBjEcT.name = jsonLoan["subject_Name"] as! String
